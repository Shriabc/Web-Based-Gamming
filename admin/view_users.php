    ...
    <?PHP include "../include/admin_sidebar.php"; ?> 
        ...
        <div class="bd-cheatsheet container-fluid bg-trasprent mt-n5">
            ...
            <article id="input-group">
                    ...
                    <h5 style="color: #000000;">View Users</h5>
                        <?PHP
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-inputgroup-prv" role="tabpanel" aria-labelledby="typo-output">
                                ...
                                <div class="input-group mb-3">
                                  <label style="color: #000000;" for="fullname" class="mt-2">Fullname : </label>
                                    <input style="color: #000000;" type="text" class="form-control border-0 bg-transparent" id="fullname" name="fullname" placeholder="Fullname"  value ="<?PHP echo $row['fullname']?>"  required autocomplete="off">
                                </div>
                                </div>
                                <div class="col-6">
                                
                                <div class="input-group mb-3">
                                <label style="color: #000000;" for="fullname" class="mt-2">Mobile : </label>
                                    <input style="color: #000000;" type="number" class="form-control border-0 bg-transparent" id="mobile" oninput="validationmobile()" value ="<?PHP echo $row['mobile']?>" name="mobile"  placeholder="Mobile No"   required autocomplete="off">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                <label style="color: #000000;" for="fullname" class="mt-2">Email : </label>
                                <input style="color: #000000;" type="text" class="form-control border-0 bg-transparent"   oninput="Check_email();"id="email" name="email" value ="<?PHP echo $row['email']?>" placeholder="Email"   required autocomplete="off">
                            </div>
                            <span id="emailerror" class="text-danger"></span>
                            <div class="input-group mb-3">
                            <label style="color: #000000;" for="fullname" class="mt-2">Address : </label>
                                <textarea style="color: #000000;" class="form-control border-0 bg-transparent" id="address" name="address"  placeholder="Address"   required autocomplete="off"><?PHP echo $row['address']?></textarea>
                            </div>
